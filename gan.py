...
############################################### IMAGE PREPROCESSING ###########################################################
'''
imports the dataset into batches and shuffles them
Also images are downsized to 128x128 pixels
...
defines placeholders, creates random fake image, 
...
###################################################################################################################
    '''
    Train the discriminator and generator with batches of images

    '''

    print('total training sample num:%d' % samples_num)
    print('batch size: %d, batch num per epoch: %d, epoch num: %d' % (batch_size, batch_num, NUM_EPOCHS))
    ...
    for i in range(NUM_EPOCHS):
        ...
        if i%50 == 0:
            ...
            save_images(imgtest, [8,8] ,new_image_path + '/epoch' + str(i) + '.png')
